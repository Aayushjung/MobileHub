...
public class LogoutServlet extends HttpServlet {
    ...
    private void handleLogout(HttpServletRequest request, HttpServletResponse response)
        ...
        // response.sendRedirect(request.getContextPath() + "/login"); // Redirect changes URL

        // OR Forward to login page (keeps URL /logout but shows login content)
        // Forwarding might be better if you want to display the logout message on the login page
