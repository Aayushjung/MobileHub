...
<%
    ...
    // Get potential error message from servlet forward
    String formErrorMessage = (String) request.getAttribute("formErrorMessageLocal");
%>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="form-card">
            ...
            <form action="${pageContext.request.contextPath}/admin/manage-products" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="category" name="category" value="<c:out value='${product.category}'/>" placeholder="e.g., Smartphone, Premium, Standard">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="imageUrl" name="imageUrl" rows="3" placeholder="Paste full data:image/... URL or a relative path"><c:out value='${product.imageUrl}'/></textarea>
                </div>
